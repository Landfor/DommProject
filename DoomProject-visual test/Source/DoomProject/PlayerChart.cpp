...
void APlayerChart::StartFire()
{

}

void APlayerChart::StopFire()
{
...
//	PlayerInputComponent->BindAxis("MoveRight", this, &APlayerChart::GetActorRightVector);
	...
	PlayerInputComponent->BindAction("Fire", IE_Pressed, this, &APlayerChart::StartFire);
	PlayerInputComponent->BindAction("Fire", IE_Released, this, &APlayerChart::StopFire);
